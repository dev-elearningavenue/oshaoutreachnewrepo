...
@section('title', 'Group Discount | '.config('app.name') )
...
@section('content')
    ...
    @include('partials._why_to_enroll_video_section',  ['classes' => 'mt-2', 'slug' => 'eddy-osha-10-general'])
            ...
            <div class="container">
                ...
                <div class="row no-gutter group-enrollment-pricing" style="border-collapse: collapse">
                    ...
                    <div class="col-md-6 col-sm-12 discounted_rates">
                        ...
                        <p class="desc pricing float-left w-50 ta-center"><span>1+</span></p>
                    ...
                    <div class="col-md-6 col-sm-12 discounted_rates">
                        ...
                        <p class="desc pricing float-left w-50 ta-center"><span>1+</span></p>
                        <p class="desc pricing w-50 float-right ta-center"><span
                                class="font-weight-900 fc-dark-red">$99</span></p>
                    </div>
                    {{-- OSHA 30 Courses --}}
                ...
                updateOrder = function (refresh = false) {
                    ...
                    if (outreachProfileCookie) {
                        ...
                        data.push(
                            ...
                            {name: "from", value: "group-discount"}
                        )
                        ...
                        if (iti.isValidNumber() == true || $('#email').val().trim() != '') {
                            ...
                            // add from key
                            data.push({name: "from", value: "group-discount"});
