...
@section('styles')
    ...
    <meta property="og:title"
          content="{{ isset($page['seo_tags']['title']) ? $page['seo_tags']['title'] : env('PROMOTION_TEXT') }}">
    ...
    <meta property="twitter:image" content="{{ url('/images/promotions/'. env('PROMOTION_NAME') .'/og-image-promotions.jpg')  }}">
    ...
    @php
        $courses_list = [
            ...
            [
                ...
                'description' => 'Enroll In OSHA 10-Hour Construction (Español) Training Online At Discounted Price. Authorized, OSHA Accepted Training Courses.',
                'id' => '7',
                'price' => 52,
                'img' => 'images/promotions/product-thumbnails/osha_10_hours_construction_spanish.jpg'
            ],
            [
            ...
            [
                'name' => 'New York OSHA 10-Hour Construction (Español)',
                'description' => 'Enroll In New York OSHA 10-Hour Construction (Español) Training Online At Discounted Price. Authorized, OSHA Accepted Training Courses.',
                'id' => '9',
                'price' => 52,
                'img' => 'images/promotions/product-thumbnails/new_york_osha_10_hours_construction_spanish.jpg'
            ]
        ];
    @endphp
...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row course">
                ...
                <div class="col-md-6 desc-div">
                    ...
                    <div class="pricing"><strong class="fc-red discounted_price">$52</strong><span
                            class="fc-grey cutout">$69</span></div>
                    ...
                    <a href="{{ route('product.addToCart', [1]) }}" class="btn --btn-small enroll-now-btn" tabindex="0">ENROLL NOW</a>
            ...
            <div class="row course">
                <div class="col-md-6 desc-div">
                    ...
                    <div class="pricing"><strong class="fc-red discounted_price">$132</strong><span
                            class="fc-grey cutout">$159</span></div>
                    ...
                    <div class="course-outline-popup" style="display: none;">
                        <div class="popup-inner-div">
                            ...
                            <div class="row">
                                <div class="col-md-12 ta-center">
                                    <a class="btn --btn-small --btn-primary close-btn-back" href="#" tabindex="1">BACK</a>
                                    <a class="btn --btn-small enroll-now-btn"
                                       href="{{ route('product.addToCart', [2]) }}" tabindex="0">ENROLL NOW</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row course">
                ...
                <div class="col-md-6 desc-div">
                    ...
                    <a href="{{ route('product.addToCart', [5]) }}" class="btn --btn-small enroll-now-btn" tabindex="0">ENROLL NOW</a>
                    <a class="btn --btn-small course-outline-btn" href="#" tabindex="1">COURSE DETAILS</a>
                    <div class="course-outline-popup" style="display: none;">
                        <div class="popup-inner-div">
                            <div class="page-heading bg-lgrey ptpx-20 pbpx-20">
                        ...
                        <div class="popup-inner-div">
                            ...
                            <div class="row">
                                <div class="col-md-12 ta-center">
                                    <a class="btn --btn-small --btn-primary close-btn-back" href="#" tabindex="1">BACK</a>
                                    <a class="btn --btn-small enroll-now-btn"
                                       href="{{ route('product.addToCart', [6]) }}" tabindex="0">ENROLL NOW</a>
                                </div>
                            </div>
    ...
    @include('partials._reviews_sa', ['backgroundWhite' => true])
