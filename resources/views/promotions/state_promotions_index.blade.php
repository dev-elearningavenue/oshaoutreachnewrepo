    ...
    <script type="application/ld+json">
{
    ...
    <style>
        /* StatePage Styling */
        .stateBanner {
            background: url("https://res.cloudinary.com/elearning-avenue24/image/upload/v1674724290/assets/oc_images/banner-1_nlfga5.jpg");
        ...
        section.courses .courseBox .courseFooter {
            position:
                absolute;
            left:
                20px;
