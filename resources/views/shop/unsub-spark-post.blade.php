...
<head>
    ...
    <style>
        body {
            ...
            padding: 0;
            background: #1583c4;
            background: -moz-linear-gradient(45deg, #1583c4 32%, #00d4ff 100%);
            background: -webkit-linear-gradient(45deg, #1583c4 32%, #00d4ff 100%);
            background: linear-gradient(45deg, #1583c4 32%, #00d4ff 100%);
...
<div class="container">
    <div class="inner-container">
        ...
        <div class="bottom">
            <h2 class="title">Sorry to see you go</h2>
            <p class="subtitle">You have successfully unsubscribed from our emails.</p>
{{--            <div class="buttons">--}}
