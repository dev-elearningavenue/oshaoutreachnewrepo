<section
    class="banner-strip @if(!in_array(Route::currentRouteName(),['courses'])) hidden-md-up @endif"
    style="@if(in_array(Route::currentRouteName(),['osha-10-and-30']))background-color: #ffffff;padding:60px 0; @else max-height: 164px; padding-bottom: 20px; @endif ">
    <div class="container">
        <div
