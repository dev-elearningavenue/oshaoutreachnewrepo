            ...
            <div class="col-md-12 ">
                <div class="start_journey">
                    <div class="start_journey_ineer_wrapper">
                        <div>
                            <h3 class="start_journey_title">Prepare For Safety Training With A Free Study Guide </h3>
                        </div>
                        <a href="{{ $btnLink }}" class="journey_sign_up_btn journey_sign_up_btn_wrapper"> Download Now</a>
                    </div>
