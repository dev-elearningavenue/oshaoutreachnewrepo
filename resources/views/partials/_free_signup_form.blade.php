        ...
        <div class="row banner_sec_row">
            <div class="col-md-7 banner_left_col">
                <div class="banner_sec_title banner_desktop_show">
                    <h1> SIGN UP FOR<span class="banner_free_span"> <i>FREE</i></span> TODAY</h1>
                    <h2>Experience The Most Trusted OSHA Training Solution. </h2>
                </div>
            ...
            <div class="col-md-5 banner_right_col">
                ...
                <div class="banner_laptop_img">
                    <img  src="{{ asset("/images/sign-up-banner-img-right.png") }}"/>
                </div>
            </div>
        </div>
    </div>
            ...
            $('#free_sign_up_form').submit(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        var mainContent = `
        <p class="success_para"> You've successfully registered for your FREE Account. </p>
        <p class="free_course_para">We've already included <b> FREE Course(s) </b> in your account, allowing you to explore our robust and adaptable learning platform. </p>
        `
                        var footer =
                            `<p class="footer_para_one"> Your login details have been dispatched to you via both Email and SMS. </p>
            ...
            or call us at: <a href="tel:+1 833 212 6742"><u> +1 833 212 6742 </u></a></p>`
                        Swal.fire({
                            ...
                            confirmButtonText: '<span class="popup_btn_start">START LEARNING NOW</span>',
