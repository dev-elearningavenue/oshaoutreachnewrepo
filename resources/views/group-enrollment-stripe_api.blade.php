            ...
            <div class="container">
                ...
                <div class="row no-gutter group-enrollment-pricing" style="border-collapse: collapse">
                    ...
                    <div class="col-md-6 col-sm-12 discounted_rates">
                        ...
                        <p class="desc pricing w-50 float-right ta-center"><span
                                class="font-weight-900 fc-dark-red">$53</span></p>
                        <p class="desc pricing float-left w-50 ta-center"><span>6-15</span></p>
                        <p class="desc pricing w-50 float-right ta-center"><span
                                class="font-weight-900 fc-dark-red">$51</span></p>
                        <p class="desc pricing float-left w-50 ta-center"><span>16+</span></p>
                        <p class="desc pricing w-50 float-right ta-center"><span
                                class="font-weight-900 fc-dark-red">$49</span></p>
                    </div>
                    {{-- OSHA 10 Courses Chart --}}
                    ...
                    <div class="col-md-6 col-sm-12 discounted_rates">
                        ...
                        <p class="desc pricing float-left w-50 ta-center"><span>2-5</span></p>
                        <p class="desc pricing w-50 float-right ta-center"><span
                                class="font-weight-900 fc-dark-red">$126</span></p>
                        <p class="desc pricing float-left w-50 ta-center"><span>6-15</span></p>
                        <p class="desc pricing w-50 float-right ta-center"><span
                                class="font-weight-900 fc-dark-red">$123</span></p>
                        <p class="desc pricing float-left w-50 ta-center"><span>16+</span></p>
                        <p class="desc pricing w-50 float-right ta-center"><span
                                class="font-weight-900 fc-dark-red">$121</span></p>
                    </div>
                    {{-- OSHA 30 Courses --}}
                </div>
                ...
                <form method="POST" class="group-enrollment-form" id="group_enrollment_form">
                    ...
                    <input type="hidden" name="uoid"
                           value="{{ 'G-' . \Carbon\Carbon::now()->timezone('Canada/Eastern')->format('Ymdhi') . mt_rand(1, 9) . mt_rand(1, 9) . mt_rand(1, 9) }}">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="group-user-details">
                                ...
                                <div class="row mbpx-20 pbpx-10" style="border-bottom: 1px solid #ddd">
                                    ...
                                    <div class="col-md-6 col-xs-12 col-sm-6">
                                        <div class="control-group focused">
                                            <strong class="fs-large course_title">OSHA 30-Hour<br>Construction
                                                Spanish</strong>
                                    ...
                                    <div class="col-md-6 col-xs-12 col-sm-6">
                                        <div class="control-group focused">
                                            <strong class="fs-large course_title">NY OSHA
                                                30-Hour<br>Construction</strong>
                                ...
                                <div class="row mbpx-20 pbpx-10" style="border-bottom: 1px solid #ddd">
                                    ...
                                    <div class="col-md-6 col-xs-12 col-sm-6">
                                        <div class="control-group focused">
                                            <strong class="fs-large course_title">OSHA 30-Hour<br>General
                                                Industry</strong>
                                    ...
                                    <div class="col-md-6 col-xs-12 col-sm-6">
                                        <div class="control-group focused">
                                            <strong class="fs-large course_title">OSHA 30-Hour<br>General Industry
                                                Spanish</strong>
                                    ...
                                    <div class="col-md-6 col-xs-12 col-sm-6">
                                        <div class="control-group focused">
                                            <strong class="fs-large course_title">NY OSHA 30-Hour<br>General
                                                Industry</strong>
                                ...
                                <div class="row mbpx-20 pbpx-10" style="border-bottom: 1px solid #ddd">
                                    ...
                                    <div class="col-md-6 col-xs-12 col-sm-6">
                                        <div class="control-group focused">
                                            <strong class="fs-large course_title">OSHA 10-Hour<br>Construction
                                                Spanish</strong>
                                    ...
                                    <div class="col-md-6 col-xs-12 col-sm-6">
                                        <div class="control-group focused">
                                            <strong class="fs-large course_title">NY OSHA
                                                10-Hour<br>Construction</strong>
                                ...
                                <div class="row mbpx-20 pbpx-10" style="border-bottom: 1px solid #ddd">
                                    ...
                                    <div class="col-md-6 col-xs-12 col-sm-6">
                                        <div class="control-group focused">
                                            ...
                                            <input type="number" id="osha_10_general_sp_qty"
                                                   name="osha_10_general_sp_qty"
                                                   class="osha_10_courses course_qty" value="0" min="0" max="200"
                                                   step="1" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');">
                                            <span class="fs-large float-right ptpx-13">x</span>
                                            <small class="qty">Qty</small>
                                    ...
                                    <div class="col-md-6 col-xs-12 col-sm-6">
                                        <div class="control-group focused">
                                            <strong class="fs-large course_title">NY OSHA 10-Hour<br>General
                                                Industry</strong>
                                            <input type="number" id="ny_osha_10_general_qty"
                                                   name="ny_osha_10_general_qty"
                                                   class="osha_10_courses course_qty" value="0" min="0" max="200"
                                                   step="1" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');">
                                            <span class="fs-large float-right ptpx-13">x</span>
                                            <small class="qty">Qty</small>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="control-group focused">
                                                ...
                                                {{ Form::text('contact_no', null, ['class' => $errors->has('contact_no') ? 'form-field error' : 'form-field', 'id' => 'contact_no', 'required' => 'required']) }}
...
{{--                            </div>--}}
{{--                            <div class="focused">--}}
{{--                                <input autocomplete="off" placeholder="Enter Coupon Code" class="form-field"--}}
{{--                                       name="coupon_code" id="coupon_code" type="text">--}}
{{--                            </div>--}}
{{--                            <div class="control-group focused">--}}
{{--                                <button type="button" id="applyCoupon" style="width: 100%"--}}
{{--                                        class="btn --btn-small --btn-primary">--}}
{{--                                    Apply--}}
{{--                                </button>--}}
{{--                                <button type="button" id="removeCoupon"--}}
{{--                                        style="width: 100%;background-color: red !important; display: none;"--}}
{{--                                        class="btn --btn-small --btn-primary">--}}
{{--                                    Remove--}}
{{--                                </button>--}}
                ...
                <div class="row">
                    <div class="box --course-objectives col-md-12 mtpx-20">
                        <p class="desc" style="text-align: left;">
                            ...
                            of the OSHA Construction and General Industry. Workers must comply with health and safety
                            standards.
                            It is not merely intended for an individual’s safety but for the safety of fellow employees
                            and your company.
                        </p>
...
@if(!$form_submit)
    @section('scripts')
        ...
        <script>
            ...
            async function updateOrder(refresh = false) {
                var data = [];
                let formDataObj = {};

                {{-- outreachProfileCookie is present in master layout --}}
                if (outreachProfileCookie) {
                    ...
                    data.push(
                        {
                            name: "_token",
                            value: $("#group_enrollment_form  input[name='_token']").val(),
                        },
                        {
                            name: "uoid",
                            value: $("#group_enrollment_form  input[name='uoid']").val(),
                        },
                        ...
                        {name: "contact_no", value: outreachProfileCookieObj["contactNo"]},
                        {name: "password", value: "-"},
                ...
                const formData = [
                    ...data.filter((item) => !item.name.includes("_qty")),
                    {
                        name: "cart",
                        value: window.cart,
                    },
                ...
                const response = await fetch("{{ url(env('LMS_API_URL') . '/shop/orders') }}", {
                    method: "PATCH",
                    headers: {
                ...
                window.orderId = result.id;

                if (result.allDetailsSaved) {
                    window.s_client_s = result.clientSecret;
                }

                console.log("I should be consoled 1st")
            }
            ...
            $(document).ready(function () {
                ...
                $('#proceed-btn-logged-in').click(async function (e) {
                ...
                function appendCoursePushInCart(title, discPrice, orgPrice, qty, total, sku) {
                    ...
                    if (qty > 1 && qty <= 5) {
                        discPrice = discountObj[discPrice][0]
                    } else if (qty > 5 && qty <= 15) {
                        discPrice = discountObj[discPrice][1]
                    } else if (qty > 15) {
                        discPrice = discountObj[discPrice][2]
                    }
                    ...
                    html += '<span class="fs-medium float-left">Subtotal: <strong class="fc-primary">$' + (parseFloat(discPrice * qty).toLocaleString(undefined, {minimumFractionDigits: 2})) + '</strong></span><br/>';
                    html += '</td>';
                    html += '</tr>';
                    ...
                    window.cart.items.push({
                        sku: sku,
                        title: title,
                        actual_price: orgPrice,
                        price: discPrice,
                        quantity: qty
                    });

                    window.cartAmount += parseFloat(discPrice * qty);
                    window.cartDiscount += parseFloat((orgPrice * qty) - (discPrice * qty));
                ...
                function updateCart() {
                    ...
                    /* Determine total course qty */
                    var total_qty = 0;
                    var qtyElements = $("input[id$='_qty']").toArray();

                    $.each(qtyElements, function (index, element) {
                        total_qty += (parseInt($(element).val()) || 0)
                    })
                    ...
                    var osha_10_price = 55.00;

                    /* osha 30 pricing */
                    var osha_30_price_original = 189.00;
                    var osha_30_price = 129.00;
                    ...
                    if (osha_10_construction_qty > 0) {
                        ...
                        html += appendCoursePushInCart("OSHA 10 Hour Construction", osha_10_price, osha_10_price_original, osha_10_construction_qty, total, 1)
                        total_amount += total;
                    }
                    ...
                    if (osha_10_general_qty > 0) {
                        ...
                        var discount = subtotal - total;
                        total_discount += discount;
                        html += appendCoursePushInCart("OSHA 10 Hour General Industry", osha_10_price, osha_10_price_original, osha_10_general_qty, total, 3)
                        total_amount += total;
                    }
                    ...
                    if (osha_30_construction_qty > 0) {
                        ...
                        var discount = subtotal - total;
                        total_discount += discount;
                        html += appendCoursePushInCart("OSHA 30 Hour Construction", osha_30_price, osha_30_price_original, osha_30_construction_qty, total, 2)
                        total_amount += total;
                    }
                    ...
                    if (osha_10_construction_sp_qty > 0) {
                        ...
                        var discount = subtotal - total;
                        total_discount += discount;
                        html += appendCoursePushInCart("OSHA 10 Hour Construction Spanish", osha_10_price, osha_10_price_original, osha_10_construction_sp_qty, total, 7)
                        total_amount += total;
                    }
                    ...
                    if (osha_10_general_sp_qty > 0) {
                        ...
                        var discount = subtotal - total;
                        total_discount += discount;
                        html += appendCoursePushInCart("OSHA 10 Hour General Industry Spanish", osha_10_price, osha_10_price_original, osha_10_general_sp_qty, total, 2312)
                        total_amount += total;
                    }
                    ...
                    if (ny_osha_10_construction_qty > 0) {
                        ...
                        var discount = subtotal - total;
                        total_discount += discount;
                        html += appendCoursePushInCart("NY OSHA 10 Hour Construction", osha_10_price, osha_10_price_original, ny_osha_10_construction_qty, total, 5)
                        total_amount += total;
                    }
                    ...
                    if (ny_osha_10_general_qty > 0) {
                        ...
                        var discount = subtotal - total;
                        total_discount += discount;
                        html += appendCoursePushInCart("NY OSHA 10 Hour General Industry", osha_10_price, osha_10_price_original, ny_osha_10_general_qty, total, 8)
                        total_amount += total;
                    }
                    ...
                    if (osha_30_general_qty > 0) {
                        ...
                        var discount = subtotal - total;
                        total_discount += discount;
                        html += appendCoursePushInCart("OSHA 30 Hour General Industry", osha_30_price, osha_30_price_original, osha_30_general_qty, total, 2314)
                        total_amount += total;
                    }
                    ...
                    if (osha_30_general_sp_qty > 0) {
                        ...
                        var discount = subtotal - total;
                        total_discount += discount;
                        html += appendCoursePushInCart("OSHA 30 Hour General Industry Spanish", osha_30_price, osha_30_price_original, osha_30_general_sp_qty, total, 2315)
                        total_amount += total;
                    }
                    ...
                    if (osha_30_construction_sp_qty > 0) {
                        ...
                        var discount = subtotal - total;
                        total_discount += discount;
                        html += appendCoursePushInCart("OSHA 30 Hour Construction Spanish", osha_30_price, osha_30_price_original, osha_30_construction_sp_qty, total, 2310)
                        total_amount += total;
                    }
                    ...
                    if (ny_osha_30_construction_qty > 0) {
                        ...
                        var discount = subtotal - total;
                        total_discount += discount;
                        html += appendCoursePushInCart("NY OSHA 30 Hour Construction", osha_30_price, osha_30_price_original, ny_osha_30_construction_qty, total, 6)
                        total_amount += total;
                    }
                    ...
                    if (ny_osha_30_general_qty > 0) {
                        ...
                        var discount = subtotal - total;
                        total_discount += discount;
                        html += appendCoursePushInCart("NY OSHA 30 Hour General Industry", osha_30_price, osha_30_price_original, ny_osha_30_general_qty, total, 2316)
                        total_amount += total;
                    }
                    ...
                    if (total_discount > 0) {
                        html += '<span class="fs-large ml-3">You just saved: <strong style="color:green;" ">$' + window.cartDiscount.toLocaleString(undefined, {minimumFractionDigits: 2}) + '</strong></span><br/>';
                    }
                    if (window.cart.coupon) {
                        var couponDiscount = calculateCouponDiscount(total_amount, window.cart.coupon);

                        // subtract coupon discount from total
                        window.cartAmount -= couponDiscount;
                    ...
                    html += '<span class="fs-large ml-3 fw-bold">Total: <strong class="fc-primary">$' + window.cartAmount.toLocaleString(undefined, {minimumFractionDigits: 2}) + '</strong></span>';
                ...
                window.updateOrderInterval = setInterval(async function () {
                    await updateOrder();
                    console.log("I should be consoled 2nd")
                }, 5000);
                ...
                $("#applyCoupon").click(async function () {
                    ...
                    // TODO: change to /api/coupon
                    const response = await fetch("{{ env('LMS_API_URL') . '/shop/promocodes' }}", {
                        method: 'post',
                        headers: {
                            'content-type': 'application/json',
                            "Accept": "application/json, text-plain, */*",
                    ...
                    // add coupon to cart
                    window.cart.coupon = res.promo_code;

                    console.log(window.cart, 1703);
            ...
            $('.group-enrollment-form').submit(async function (e) {
                e.preventDefault();

                var form_step = $('#form_step').val();
                if (iti.isValidNumber() !== true || !checkFormUserDetails()) {
                    return false;
                } else if (window.cartAmount == 0) {
                    // $('#error-msg-add-courses').show();
            ...
            function renderStripeElements() {
                ...
                var data = {
                    uoid: $("#group_enrollment_form  input[name='uoid']").val(),
                };

                if (!window.s_client_s) {
                    alert("Please fill all details correctly to continue");
                    getStep(1)
                    return;
                }
                ...
                var elements = stripe.elements({
                    clientSecret: window.s_client_s
                });
                ...
                $(".pay-now-btn").on("click", function (event) {
                    ...
                    payWithCard(stripe, card, window.s_client_s, elements, userDetailsObj);
                })
            ...
            var payWithCard = function (stripe, card, clientSecret, elements, userDetailsObj) {
                ...
                stripe
                    .confirmPayment({
                        elements,
                        confirmParams: {
                            return_url: "{{ url('stripe/capture-redirect-payments') }}/" + window.orderId,
                            shipping: {
                                address: {
                                    city: userDetailsObj.city,
                                    country: "US",
            ...
            var orderComplete = function (paymentIntentId, paymentResult) {
                ...
                // Mark Order as Paid
                fetch("{{ url(env('LMS_API_URL') . '/shop/orders/') }}" + window.orderId + '/updatePayment', {
                    method: 'PATCH',
                    headers: {
                        'content-type': 'application/json',
                        "Accept": "application/json, text-plain, */*",
                                ...
                                if (data.status) {
                                    sendOrderLog({
                                        ...
                                        .then(function () {
                                            ...
                                            {{-- Set Auth Cookie --}}
                                                document.cookie = `osha-outreach-token=${data.auth_token};expires=${myDate};domain={{ env('COOKIE_DOMAIN') }};path=/`;

                                            {{-- Set Profile Cookie --}}
                                                document.cookie = `osha-outreach-profile=${JSON.stringify(data.profile)};expires=${myDate};domain={{ env('COOKIE_DOMAIN') }};path=/`;

                                            window.location.href = '{{ url('/success?order_id=') }}' + data.id;
                                            return true;
                                        });
                                } else {
                                    // $('.loader').hide();
            ...
            $('#prev-step-btn').click(async function () {
                var form_step = $('#form_step').val();
                $('#form_step').val(--form_step);
            ...
            async function getStep(step_no) {
                if (step_no == 1) {
                    $('#prev-step-btn').hide();
