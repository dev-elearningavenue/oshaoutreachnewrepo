    ...
    <section class="sec-padding cart-form mtpx-30">
        <div class="container">
            <div class="col-md-8">
                ...
                {!! Form::open(['route' => 'admin.users.store', 'method' => 'post', 'id' => 'user_creation_form']) !!}
                    ...
                    <div class="row mtpx-20">
                        <div class="col-md-6">
                            <div class="control-group focused">
                                ...
                                {{ Form::select('status', [0 => 'Inactive', 1 => 'Active'], old('status', $form_fields['status'] ?? 1) , ['id' => 'status', 'class' => $errors->has('status') ? 'form-field error ' : 'form-field', 'id' => 'status', 'required' => 'required']) }}
                        ...
                        <div class="col-md-6">
                            <div class="control-group focused">
                                ...
                                {{ Form::select('type', $arrays::roles(), old('type', $form_fields['type'] ?? 2) , ['id' => 'type', 'class' => $errors->has('type') ? 'form-field error ' : 'form-field', 'id' => 'type', 'required' => 'required']) }}
                                @if ($errors->has('type'))
...
{{--                            <input type="hidden" name="course_for" value="0" />--}}
                    ...
                    <div class="row">
                        <div class="col-md-6 offset-md-6 text-sm-center">
                            <button type="submit" id="user-submit" class="btn --btn-primary float-md-right mbpx-20">Save <i class="xicon icon-arrow-right"></i></button>
